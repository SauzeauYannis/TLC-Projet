...
{
  "$end", "error", "$undefined", "SIZE", "NAME", "DISPLAY", "MOVE",
  "LINE", "RECTANGLE", "COLOR", "OPADD", "OPSUB", "OPMUL", "OPDIV", "VAR",
  "LOOP", "END", "AFFECT", "SC", "LPAR", "RPAR", "COMMA", "ID", "NAME_W",
  "NUM", "COLOR_VAL", "DOWN", "UP", "$accept", "program", "header", "code",
  "instruction", "declaration", "affectation", "loop", "move", "color",
  "value", "pos", YY_NULLPTR
};
#endif
...
{
       6,    -4,    20,   -28,   -14,     3,   -28,    32,   -28,   -28,
      53,    25,    -4,    -4,    -4,     5,     9,    11,    17,   -28,
...
{
       0,     3,    29,    30,    19,    39,     0,    31,    22,    24,
      38,    18,     6,     7,     8,     9,    14,    15,    22,    26,
...
#line 56 "parseur.yy"
	...
	if ((yyvsp[0].inst) != nullptr) c->add((yyvsp[0].inst));
    fullinstruction =  new Program(c);
}
#line 1396 "parseur.tab.cc"
    break;
...
#line 118 "parseur.yy"
	...
	Pen *p2 = new Pen(true);
	Travel *t2 = new Travel((yyvsp[0].expr));
